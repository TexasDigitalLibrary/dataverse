...
@WebServlet(name = "TwoFactorAuthenticationResponse", urlPatterns = {"/two-factor/response"})
public class DuoTwoFactorAuthenticationServlet extends HttpServlet {
	
	private static final Logger logger = Logger.getLogger(DuoTwoFactorAuthenticationServlet.class.getCanonicalName());
	...
	public DuoTwoFactorAuthenticationServlet() {
		super();
	}
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sig_response != null) {
        	...
        	String username = duoTwoFactorAP.getUsername().trim();
